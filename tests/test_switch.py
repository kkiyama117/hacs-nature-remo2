...
import pytest
from custom_components.hacs_nature_remo.coordinators import (
    HacsNatureRemoDataUpdateCoordinator,
)
from custom_components.hacs_nature_remo.domain.config_schema import KEY_APPLIANCES
from custom_components.hacs_nature_remo.domain.config_schema import KEY_DEVICES
from custom_components.hacs_nature_remo.domain.config_schema import KEY_USER
from custom_components.hacs_nature_remo.domain.const import DEFAULT_NAME
